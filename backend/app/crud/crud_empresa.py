...
def _decrypt_sensitive_fields(empresa: Empresa) -> SimpleNamespace:
    ...
    ns = SimpleNamespace(
        ...
        send_method_email=getattr(empresa, 'send_method_email', True),
        send_method_whatsapp=getattr(empresa, 'send_method_whatsapp', False),
        whatsapp_api_system=getattr(empresa, 'whatsapp_api_system', 'MK Auth'),
        whatsapp_api_user=getattr(empresa, 'whatsapp_api_user', None),
